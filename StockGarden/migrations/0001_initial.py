# Generated by Django 5.1.5 on 2025-03-22 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice', to='StockGarden.invoice')),
        ...
        migrations.AddField(
            model_name='invoice',
            name='sales',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='StockGarden.sales'),
        ),
        migrations.CreateModel(
            name='Expense',
            fields=[
