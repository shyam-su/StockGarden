    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('Esewa', 'Esewa'), ('Cash on Hands', 'Cash on Hands'), ('Bank Transfer', 'Bank Transfer'), ('Khalti', 'Khalti')], db_index=True, max_length=255)),
                ('contact_no', models.CharField(blank=True, max_length=15, null=True)),
        ...
        migrations.AddIndex(
            model_name='repair',
            index=models.Index(fields=['product_name', 'device_model', 'in_date', 'status'], name='StockGarden_product_c7c1d4_idx'),
        ),
        migrations.AddIndex(
