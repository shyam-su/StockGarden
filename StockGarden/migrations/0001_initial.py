    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('Bank Transfer', 'Bank Transfer'), ('Cash on Hands', 'Cash on Hands'), ('Esewa', 'Esewa'), ('Khalti', 'Khalti')], db_index=True, max_length=255)),
